...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('♻️ Updates', url='https://t.me/Tamil_Mvs_Offl')
            ],
            [
        ...
        await asyncio.sleep(2) # 😢 https://github.com/Kajee0311/FilterX/blob/master/plugins/p_ttishow.py#L17 😬 wait a bit, before checking.
